...
--
-- Host: 127.0.0.1
-- Tempo de geração: 01-Abr-2025 às 10:15
...
INSERT INTO `master_acao` (`id`, `descricao`, `status`, `data_inicio`, `data_fim`, `id_atividade_anual`, `id_departamento_responsavel`, `responsavel_nome`, `id_departamento_auxiliar`, `responsavel_auxiliar_nome`, `id_processo`, `obs`, `datecreate`, `dateupdate`) VALUES
