...
from .views import list_home,mudar_balanço,balanco_g,list_balanco_geral,ver_balanco_geral,edit_balanço_geral,bloquear_balanco,desbloquear_balanco
...
urlpatterns = [     
     ...
     path('desbloquear_balanco/', desbloquear_balanco, name='desbloquear_balanco'),
